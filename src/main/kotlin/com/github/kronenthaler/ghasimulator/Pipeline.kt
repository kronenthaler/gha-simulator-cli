...
class Pipeline(val name: String, val jobQueue: JobQueue, val stats: List<Stats>, val roots: List<Job>) {
    ...
    companion object {
        fun loadFromYaml(file: File, jobQueue: JobQueue, stats: List<Stats>): Pipeline {
            val yaml = Yaml()
